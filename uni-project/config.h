...
const uint8_t  kLightSensorThreshold  = 40;   // percent. Higher = more sensitive.
...
const uint16_t kMorseDotDuration      = 100;  // milliseconds
const uint16_t kMorseDashDuration     = 400;  // milliseconds
const uint16_t kMorseSymbolInterval   = 100;  // milliseconds
const uint16_t kMorseLetterInterval   = 200;  // milliseconds
const uint16_t kMorseWordInterval     = 500;  // milliseconds
